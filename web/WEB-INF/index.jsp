...
<h1>
    ...
    <br>
Destination Name: <input  type="text" name="destinationName" id="destinationName" form="hotelform">
Destination City: <input  type="text" name="destinationCity" id="destinationCity" form="hotelform">
Region Ids: <input  type="text" name="regionIds" id="regionIds"form="hotelform">
<br>
...
lenght Of Stay: <input  type="number" name="lenghtOfStay" id="lenghtOfStay"form="hotelform">
<br>
min Star Rating: <input  type="number" name="minStarRating" id="minStarRating" form="hotelform">
maxStarRating: <input   type="number" name="maxStarRating"id="maxStarRating" form="hotelform">
<br>
min Total Rate: <input  type="number" name="minTotalRate" id="minTotalRate" form="hotelform">
max Total Rate: <input  type="number" name="maxTotalRate" id="maxTotalRate" form="hotelform">
<br>
min Guest Rate: <input  type="number" name="minGuestRate" id="minGuestRate" form="hotelform">
max Guest Rate: <input  type="number" name="maxGuestRate" id="maxGuestRate" form="hotelform">
